...
export default function ShowFoamPrice() {
  const { partA, partB, precioA, precioB } = FoamIndex(); // Obtener los valores de FoamIndex
    ...
    <CalculatorContainer>
      ...
      <SectionContainer>
        <Display>
          ...
          <ValueText>{partA.toFixed(2)}</ValueText>
        </Display>
        <Display>
          <TitleText>Piezas Parte B</TitleText>
          <ValueText>{(partB).toFixed(2)}</ValueText>
        </Display>
      </SectionContainer>
      ...
      <SectionContainer>
        <Display>
          ...
          <ValueText>${precioA.toFixed(4)}</ValueText>
        </Display>
        <Display>
          <TitleText>Precio por Pieza B</TitleText>
          <ValueText>${(precioB).toFixed(4)}</ValueText>
        </Display>
      </SectionContainer>
    </CalculatorContainer>
  );
