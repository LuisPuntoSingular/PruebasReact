...
import EvaIndex from "@/context/EvaContext/EvaIndex"; // Importa el índice de EVA
...
export default function ShowEvaPrice() {
  const { partA, partB, precioA, precioB } = EvaIndex(); // Usa EvaIndex para obtener los cálculos
    ...
    <CalculatorContainer>
      ...
      <SectionContainer>
        <Display>
          ...
          <ValueText>{partA}</ValueText>
        </Display>
        <Display>
          <TitleText>Piezas Parte B</TitleText>
          <ValueText>{partB}</ValueText>
        </Display>
      </SectionContainer>
      ...
      <SectionContainer>
        <Display>
          ...
          <ValueText>${(precioA ?? 0).toFixed(2)}</ValueText>
        </Display>
        <Display>
          <TitleText>Precio por Pieza B</TitleText>
          <ValueText>${(precioB ?? 0).toFixed(2)}</ValueText>
        </Display>
      </SectionContainer>
    </CalculatorContainer>
  );
